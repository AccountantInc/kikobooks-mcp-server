...
import { listKikoBooksPayments } from "../handlers/list-kikobooks-payments.handler.js";
...
const toolHandler = async (args: any) => {
    const response = await listKikoBooksPayments(args);
...
export const ListPaymentsTool: ToolDefinition<typeof toolSchema> = {
    name: "list_payments",
    description:
